...
class DiagramBuilder {
  ...
  rankdir=TB;
  node [shape=box, style="rounded,filled", fillcolor="#5E6AD2", fontcolor=white];
  edge [color="#26B5CE"];

  User [label="👤 User"];
  LB [label="⚖️ Load Balancer"];
  Web1 [label="🌐 Web Server 1"];
  Web2 [label="🌐 Web Server 2"];
  App [label="⚙️ Application"];
  DB [label="🗄️ Database"];
  ...
  App -> DB;
    ...
    style Internet fill:#26B5CE,color:#fff
    style Firewall fill:#FF6B6B,color:#fff
    style DB fill:#5E6AD2,color:#fff`,
      uml: `classDiagram
    class User {
        +int id
        +string name
